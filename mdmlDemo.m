% MDMLDEMO   Demonstrates how to run MDML (mirror descent for metric learn-
% ing), which learns a low-dimensional (sparse) Mahalabonis metric, given
...
%
% The Original (2d+8d garbage) is 2 relevant dimensions + 8 garbage dimensions.  
%
% version 2.1
...
for j = 1:2
    ...
    for i = 1:3
        ...
        handles(i, j) = axes('Units','normalized',...
                             'Position', [startX startY figSizeX figSizeY]); 
